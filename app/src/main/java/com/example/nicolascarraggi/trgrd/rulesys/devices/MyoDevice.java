...
public class MyoDevice extends Wearable implements InputActionDevice {
    ...
    public MyoDevice(RuleSystemService ruleSystemService, DeviceManager deviceManager, EventType evGesture){
        ...
        // INPUT ACTION EVENTS
        this.mIaEvGest = new InputActionEvent(deviceManager.getNewId(),"MYO armband ... gesture is made","gesture", R.drawable.ic_gesture_black_24dp, this, evGesture, ruleSystemService.getRuleEngine());
